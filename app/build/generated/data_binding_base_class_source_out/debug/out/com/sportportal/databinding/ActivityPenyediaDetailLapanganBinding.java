...
public final class ActivityPenyediaDetailLapanganBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final MaterialButton btnAddCourt;
  ...
  private ActivityPenyediaDetailLapanganBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull MaterialButton btnAddCourt, @NonNull MaterialButton btnDelete,
      @NonNull MaterialButton btnEdit, @NonNull AppCompatButton btnMap, @NonNull TextView category,
      @NonNull CollapsingToolbarLayout collapsingToolbar, @NonNull RecyclerView courtList,
      @NonNull ImageView image, @NonNull LinearLayout lytExpandCourt,
      @NonNull LinearLayout lytExpandLokasi, @NonNull LinearLayout lytExpandUnavailable,
      @NonNull NestedScrollView nestedScrollView, @NonNull CoordinatorLayout parentView,
      @NonNull TextView title, @NonNull Toolbar toolbar, @NonNull TextView tvLokasi,
      @NonNull RecyclerView unavailableList) {
    this.rootView = rootView;
    this.appBarLayout = appBarLayout;
    this.btToggleCourt = btToggleCourt;
    this.btToggleLokasi = btToggleLokasi;
    this.btToggleUnavailable = btToggleUnavailable;
    this.btnAddCourt = btnAddCourt;
  ...
  @NonNull
  public static ActivityPenyediaDetailLapanganBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityPenyediaDetailLapanganBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_penyedia_detail_lapangan, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityPenyediaDetailLapanganBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btn_add_court;
      MaterialButton btnAddCourt = ViewBindings.findChildViewById(rootView, id);
      if (btnAddCourt == null) {
        break missingId;
      }
      ...
      return new ActivityPenyediaDetailLapanganBinding((CoordinatorLayout) rootView, appBarLayout,
          btToggleCourt, btToggleLokasi, btToggleUnavailable, btnAddCourt, btnDelete, btnEdit,
          btnMap, category, collapsingToolbar, courtList, image, lytExpandCourt, lytExpandLokasi,
