...
public final class ActivityCustomerJadwalBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityCustomerJadwalBinding(@NonNull CoordinatorLayout rootView,
  ...
  @NonNull
  public static ActivityCustomerJadwalBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCustomerJadwalBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_customer_jadwal, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCustomerJadwalBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCustomerJadwalBinding((CoordinatorLayout) rootView, btnPesan, btnReset,
          etWhen, etWhenView, refresh, scheduleList);
    }
