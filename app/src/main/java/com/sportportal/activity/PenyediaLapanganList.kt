...
class PenyediaLapanganList : PenyediaNavigationDrawer() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.floatingAddLapangan.setOnClickListener {
            moveToAdd()
        }
    }
    ...
    private fun moveToDetails(bundle : Bundle){
        val intent = Intent(baseContext,PenyediaDetailLapangan::class.java)
        intent.putExtras(bundle)
        startActivity(intent)
    }

    private fun moveToAdd(){
        val intent = Intent(baseContext,PenyediaTambahLapangan::class.java)
        startActivity(intent)
    }
}