...
import com.sportportal.databinding.ActivityPenyediaDetailLapanganBinding
...
class PenyediaDetailLapangan : PenyediaNavigationDrawer() {

    private lateinit var binding : ActivityPenyediaDetailLapanganBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPenyediaDetailLapanganBinding.inflate(layoutInflater)
        ...
        db.collection("court")
            ...
            .addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    if (court.isEmpty()) {
                        adapter = PenyediaCourtAdapter(court)
    ...
    private fun moveToEdit(bundle: Bundle) {
        val intent = Intent(baseContext,PenyediaEditLapangan::class.java)
    ...
    private fun moveToAdd() {
        val intent = Intent(baseContext,PenyediaTambahCourt::class.java)
        intent.putExtra("idLapangan", data_lapangan.id)
        startActivity(intent)
    }
