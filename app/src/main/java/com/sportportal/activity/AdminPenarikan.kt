...
class AdminPenarikan : AdminNavigationDrawer() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnAddPenarikan.visibility = View.GONE
        binding.totalBalanceTitle.text = "Total Nilai Penarikan Pada Sistem"
