...
import com.sportportal.databinding.ActivityPenyediaPesananLapanganListBinding
import com.sportportal.extra.Lapangan
import java.io.Serializable

class PenyediaPesananLapanganList : PenyediaNavigationDrawer() {

    private lateinit var binding : ActivityPenyediaPesananLapanganListBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPenyediaPesananLapanganListBinding.inflate(layoutInflater)
    ...
    private fun moveToDetails(bundle : Bundle){
        val intent = Intent(baseContext,PenyediaPesananList::class.java)
