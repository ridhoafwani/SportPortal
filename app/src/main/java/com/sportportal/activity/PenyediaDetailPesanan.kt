...
import com.sportportal.databinding.ActivityPenyediaDetailPesananBinding
import com.sportportal.extra.saveBitmap

class PenyediaDetailPesanan : AppCompatActivity() {

    private lateinit var binding : ActivityPenyediaDetailPesananBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPenyediaDetailPesananBinding.inflate(layoutInflater)
        ...
        when(status){
            "PAID" ->{
                binding.btnExpire.visibility = View.GONE
                    ...
                    .addOnCompleteListener { task ->
                        if (task.isSuccessful) {
                            ...
                            when (status) {
                                ...
                                "PENDING" -> {
                                    binding.btnExpire.visibility = View.VISIBLE
                                    binding.btnShare.visibility = View.GONE
