...
import com.sportportal.databinding.ActivityPenyediaTambahJadwalPesananOfflineBinding
...
class PenyediaTambahJadwalPesananOffline : PenyediaNavigationDrawer(), JadwalListener {

    private lateinit var binding: ActivityPenyediaTambahJadwalPesananOfflineBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPenyediaTambahJadwalPesananOfflineBinding.inflate(layoutInflater)
    ...
    private fun moveToOfflineChekout(bundle: Bundle) {
        val intent = Intent(baseContext,PenyediaChekoutPesananOffline::class.java)
